...
def upgrade() -> None:
    ...
    op.drop_column('balance_sheet', 'Total Equity Gross Minority Interest', schema='stocks')
    op.drop_column('balance_sheet', 'Stockholders Equity', schema='stocks')
    op.drop_column('balance_sheet', 'Gains Losses Not Affecting Retained Earnings', schema='stocks')
    ...
    op.drop_column('balance_sheet', 'Total Liabilities Net Minority Interest', schema='stocks')
    op.drop_column('balance_sheet', 'Total Non Current Liabilities Net Minority Interest', schema='stocks')
    op.drop_column('balance_sheet', 'Other Non Current Liabilities', schema='stocks')
    op.drop_column('balance_sheet', 'Tradeand Other Payables Non Current', schema='stocks')
    op.drop_column('balance_sheet', 'Long Term Debt And Capital Lease Obligation', schema='stocks')
    ...
    op.drop_column('balance_sheet', 'Current Debt And Capital Lease Obligation', schema='stocks')
    ...
    op.drop_column('balance_sheet', 'Cash Cash Equivalents And Short Term Investments', schema='stocks')
