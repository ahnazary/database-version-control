...
Revision ID: dacd323cc69b
Revises: 
Create Date: 2024-01-28 22:58:33.703613
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("balance_sheet_annual_available", sa.Boolean(), nullable=True),
        sa.Column("cashflow_annual_available", sa.Boolean(), nullable=True),
        sa.Column("income_stmt_annual_available", sa.Boolean(), nullable=True),
        sa.Column("financials_annual_available", sa.Boolean(), nullable=True),
        sa.Column("balance_sheet_quarterly_available", sa.Boolean(), nullable=True),
        sa.Column("cashflow_quarterly_available", sa.Boolean(), nullable=True),
        sa.Column("income_stmt_quarterly_available", sa.Boolean(), nullable=True),
        sa.Column("financials_quarterly_available", sa.Boolean(), nullable=True),
        sa.PrimaryKeyConstraint("ticker"),
        schema="stocks",
    )
